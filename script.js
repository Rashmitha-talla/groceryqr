...
const products = [
    ...
    },
    {
      ...
      price: 75,
      image: "images/bakery/bread.webp",
      description: "700gm",
    },
    {
      id: 11,
    ...
    },
    {
      ...
      category: "beverages",
      price: 60,
      image: "images/beverages/fizz.webp",
      description: "1L",
    },
    {
      id: 14,
      ...
      category: "beverages",
      price: 10,
      image: "images/beverages/frooti.webp",
      description: "125ml",
    },
    {
      id: 15,
      ...
      category: "beverages",
      price: 40,
      image: "images/beverages/mazaa.webp",
      description: "600ml",
    },
    {
      id: 16,
    ...
    },
    {
      ...
      category: "snacks",
      price: 20,
      image: "images/snacks/tooyum.webp",
      description: "50gm",
    },
    {
      id: 18,
      ...
      category: "snacks",
      price: 10,
      image: "images/snacks/bourbon.webp",
      description: "50gm",
    },
  ]
  ...
  // Initialize placeholder images for categories and products
  // function initializePlaceholderImages() {
  //   // Replace image paths with placeholder URLs
  //   const categoryImages = {
  //     fruits: "/placeholder.svg?height=150&width=200&text=Fruits",
  //     vegetables: "/placeholder.svg?height=150&width=200&text=Vegetables",
  //     dairy: "/placeholder.svg?height=150&width=200&text=Dairy",
  //     bakery: "/placeholder.svg?height=150&width=200&text=Bakery",
  //     beverages: "/placeholder.svg?height=150&width=200&text=Beverages",
  //     snacks: "/placeholder.svg?height=150&width=200&text=Snacks",
  //   }
  
  //   // Update category images
  //   document.querySelectorAll(".category-card img").forEach((img) => {
  //     const category = img.parentElement.dataset.category
  ...
  //     product.image = `/placeholder.svg?height=200&width=300&text=${encodeURIComponent(product.name)}`
  //   })
  
  //   // Update about page images
  //   const aboutStoreImg = document.querySelector(".about-image img")
  //   if (aboutStoreImg) {
  //     aboutStoreImg.src = "/placeholder.svg?height=400&width=600&text=Our Store"
  //   }
  
  //   // Update team images
  //   document.querySelectorAll(".team-member img").forEach((img, index) => {
  //     img.src = `/placeholder.svg?height=150&width=150&text=Team Member ${index + 1}`
  //   })
  // }
  
  // Call this function to initialize placeholder images
